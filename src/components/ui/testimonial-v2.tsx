                  ...
                  <blockquote className="m-0 p-0">
                    ...
                    <footer className="flex items-center gap-3 mt-6">
                      <Image
                        ...
                        src={image}
                        alt={`Avatar of ${name}`}
                        className="h-10 w-10 rounded-full object-cover ring-2 ring-neutral-100 group-hover:ring-primary-600/30 transition-all duration-300 ease-in-out"
                      />
...
export default function TestimonialV2() {
  return (
    <div className="w-full min-h-screen bg-white transition-colors duration-300 flex flex-col justify-center relative selection:bg-primary-600 selection:text-white">
      <TestimonialsSection />
    </div>
  )
}
