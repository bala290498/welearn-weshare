...
export const metadata: Metadata = {
  title: 'Prime Batch - WeLearnWeShare',
  description: 'Start immediately. Learn with focus. Join our Prime Batch for time-based learning with smaller, focused groups.',
  openGraph: {
    title: 'Prime Batch - WeLearnWeShare',
    description: 'Start immediately. Learn with focus. Join our Prime Batch for time-based learning with smaller, focused groups.',
    type: 'website',
    url: 'https://welearnweshare.com/prime',
        ...
        <div className="container mx-auto px-4 max-w-[960px]">
          ...
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-slate-200 flex flex-col">
            ...
            <div 
              ...
              style={{
                backgroundImage: `linear-gradient(0deg, rgba(234, 88, 12, 0.9) 0%, rgba(234, 88, 12, 0.7) 50%, rgba(234, 88, 12, 0.4) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuBsF7PlGcC9I_rhg6unh-fIfOAJP5GIQpchpGlBh3VVGBosELY3B-NFmD_IjQpnSJsfY69iCAbi4L7UBoeEvBXvTVp-Ur-rnbjdxAkXNkIsIdi6DvkOYOjPwJs69Y9NDGSy-IhodZByW7PZegFzCbvd4U0xw5YTULI5wElxBXU5Oble35UaWV4D3yk1GhYRRN2B-r4aAw8VTpXPt1rStVBUZvgREFrRIwxP0Hb8hqRaA-BlVSDR9f9P7St0hJZdL0EMaGrjSDQkz3I")`
              }}
            >
            ...
            <div className="flex flex-col gap-8 p-6 sm:p-8">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-orange-50 border border-orange-200 px-4 transition-colors hover:border-orange-500/50">
                  <Clock className="w-5 h-5 text-orange-600" />
                  <p className="text-orange-700 text-sm font-medium">Best for: Urgent Learners</p>
                </div>
                <div className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-orange-50 border border-orange-200 px-4 transition-colors hover:border-orange-500/50">
                  <School className="w-5 h-5 text-orange-600" />
                  <p className="text-orange-700 text-sm font-medium">Model: Time-based</p>
                </div>
                <div className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-orange-50 border border-orange-200 px-4 transition-colors hover:border-orange-500/50">
                  <Calendar className="w-5 h-5 text-orange-600" />
                  <p className="text-orange-700 text-sm font-medium">Start: Immediate</p>
                </div>
              </div>
              ...
              <div className="pt-4">
                ...
                <p className="text-center text-slate-500 text-sm mt-3">
                  Need help with scheduling? <a className="text-orange-600 hover:underline" href="/contact">Contact Sales</a>
                </p>
              </div>
            </div>
          </div>
