...
import { Users, Calendar, School, DollarSign, CheckCircle, ArrowRight, Wallet, Users2, Clock, ChevronLeft, TrendingDown, Award, BarChart3, FileText, Briefcase, ClipboardCheck, BookOpen, Video, Download } from 'lucide-react'
          ...
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-slate-200 flex flex-col">
            ...
            >
              <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8">
                <div className="flex flex-col gap-2 items-start">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider bg-purple-600 text-white shadow-sm">
                    Best Value
                  </span>
                  <h1 className="text-white text-3xl sm:text-4xl font-semibold leading-tight">Collective Batch</h1>
            ...
            <div className="flex flex-col gap-8 p-6 sm:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col justify-between gap-4 rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-purple-500 hover:shadow-lg hover:shadow-purple-500/10">
                    <div className="flex flex-col gap-2">
                      <h4 className="text-slate-500 text-sm font-semibold uppercase tracking-wider">Small Group</h4>
                    ...
                    <button className="w-full mt-2 cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-white border border-slate-200 text-slate-900 hover:bg-purple-50 text-sm font-semibold transition-colors">
                      Select Tier
                    </button>
                  </div>
                  ...
                  <div className="flex flex-col justify-between gap-4 rounded-xl border-2 border-purple-500/30 bg-purple-500/5 p-6 relative overflow-hidden">
                    {/* Popular badge */}
                    <div className="absolute top-0 right-0 bg-purple-600 text-white text-[10px] font-semibold px-2 py-1 rounded-bl-lg uppercase tracking-wider">
                      Best Value
                    </div>
                    <div className="flex flex-col gap-2">
                      <h4 className="text-purple-600 text-sm font-semibold uppercase tracking-wider">Large Group</h4>
                      <div className="flex items-baseline gap-1 text-slate-900">
                    ...
                    <button className="w-full mt-2 cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-purple-600 text-white hover:bg-purple-700 text-sm font-semibold transition-colors shadow-md shadow-purple-500/20">
                      Select Tier
                    </button>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-4 pt-2 border-t border-slate-200">
                <h3 className="text-slate-900 text-xl font-semibold leading-tight mt-4">Why choose Collective?</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="flex flex-col gap-2 p-4 rounded-lg bg-purple-50">
                    ...
                    <h5 className="text-slate-900 font-semibold text-base">Lowest Price</h5>
                  ...
                  <div className="flex flex-col gap-2 p-4 rounded-lg bg-purple-50">
                    ...
                    <h5 className="text-slate-900 font-semibold text-base">Flexible Timelines</h5>
              ...
              <div className="pt-4">
                <a
                  href="/courses?batchType=collective"
                  className="w-full py-4 px-6 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-semibold text-lg shadow-lg shadow-purple-500/25 transition-all transform active:scale-[0.99] flex items-center justify-center gap-2"
                >
